...
Este es el inventario Kea creado en AWX, formado por el servidor yoda.

![alt text](image-3.png)

A continuación, se ha creado un grupo kea-bind-router_servers dentro del inventario, que incluye al servidor `solo`.
